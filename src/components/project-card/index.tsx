...
const ProjectCard = ({ project }: ProjectCardProps) => {
	...
	return (
		<div className='group relative rounded-xl border border-base-700/50 bg-base-800/30 shadow-2xl'>
			<div className='absolute -left-px top-3/4 h-14 w-px bg-gradient-to-b from-transparent via-secondary-400 to-transparent opacity-0 transition-all duration-500 group-hover:top-1/4 group-hover:opacity-100' />
			<Link

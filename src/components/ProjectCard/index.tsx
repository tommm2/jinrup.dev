...
const ProjectCard = ({ project }: ProjectCardProps) => {
	...
	return (
		<div className='group relative rounded-xl border border-base-200 bg-base-100 transition-all duration-300 hover:shadow-card dark:border-base-800 dark:bg-base-900'>
